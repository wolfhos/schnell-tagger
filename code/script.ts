...
const startverzeichnis: string = 'c:/web/schnell-tagger/code';//Wert nur ändern, wenn das Startverzeichnis ein anderes als das Document Root des Webservers sein soll. Technisch ist jedoch nur ein Unterverzeichnis von Document Root möglich
...
class RahmenRechts {
    ...
    _listeZuBearbeitendeBilder: Bild[]; //für das Aktualiseren der Stichwörter nach Schreiben oder Löschen benötigen wir diese Liste
    ...
    vorbereitungLoeschen(): void {
        ...
        if (this._schreibenBlockiert == false) {
            ...
            let listeLoeschbilderHtml: string[] = this._listeZuBearbeitendeBilder.map(bild => "<br>" + bild._name);
